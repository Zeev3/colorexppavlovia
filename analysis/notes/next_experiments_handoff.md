...
- **Do not call the narrowing "compensation" or "hedging" as a fact.** The user rejected that framing: the data cannot tell why reports narrow. Describe it neutrally ("reports narrow"), and list the candidate explanations.
