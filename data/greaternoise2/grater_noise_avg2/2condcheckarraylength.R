...
# Read datasets
exp_raw <- read.csv("/Users/zeevbenamos/Documents/GitHub/colorexppavlovia/data/greater_noise_exp2/data_cleaned.csv")
avg_raw <- read.csv("/Users/zeevbenamos/Documents/GitHub/colorexppavlovia/data/grater_noise_avg2/data_cleaned.csv")
...
working_model <-  RttM_model_simpler_4 #put here the model that converged 
